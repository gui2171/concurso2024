...
def is_within_rs(lat, lon):
    """Check if the coordinates are within the geographical boundaries of Minas Gerais."""
    return -22.0 <= lat <= -14.0 and -51.0 <= lon <= -39.0
...
if __name__ == "__main__":
    ...
    extracted_text = extract_info(html_content, "MINAS GERAIS", "ESPÍRITO SANTO")
